...
def main():
    ...
    from_disk = True
    # output_path = '/local_data/magnolia/experiment_data/date_2017_09_28_time_13_14/aux/evaluations/large_lab41/in_sample_test'
    output_path = '/local_data/magnolia/experiment_data/date_2017_09_28_time_13_14/aux/evaluations/large_lab41/out_of_sample_test'
    eval_sr = 8000
    ...
    for _ in tqdm.trange(mixer.epoch_size()):
        ...
        # use model + clustering to source-separate the spectrogram
