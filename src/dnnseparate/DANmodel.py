...
class DANModel:
    def __init__(self, F=257, num_speakers=251,
        ...
        [1] Chen, Zhuo, Yi Luo, and Nima Mesgarani. "Deep attractor network
            for single-microphone speaker separation." (2016)
    ...
    def train_on_batch(self, X_train, y_train, I_train, S_train):
        """
